export default {
  ...
  baseHost: "https://api.gosteady.cc",
  configApi: "https://getconfig.gosteady.net",
  avatarUrl: "https://getconfig.gosteady.net/api/file/download/avatar",
  policyUrl: "https://h5.gosteady.net/",
  countryCode: "SG",
  cloudCallClientKey: "steady-work-web",
  cloudCallAppKey: "swprdsg",
};
